						...
						<el-table-column fixed="right" label="Action" style='background:. red;'>
							<template slot-scope="scope">
								<div style="white-space: nowrap;">
									<el-button @click="activity(scope.row.reference)" type="danger" size="small">Activity</el-button>
									<el-button @click="parsonnel(scope.row.reference)" type="danger" size="small">Members</el-button>
									<!-- <el-button @click="grounpcreate(scope.row.reference)" type="danger" size="small">Alert</el-button>
...
<script>
	...
	methods: {
		...
		search(){
			...
			this.$api.get('/PlvKGroupEndpoint/seekMyGroup',null, r => {
				//console.log(r)
				// this.search()
				this.tableData = r
...
// 		},
		...
		activity(id){
			this.$router.push("/activityList?groupid="+id)
		},
		// 刪除
		shanchu_detele(uuid){
