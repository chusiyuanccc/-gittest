	...
	<div class="MoBangXinZengAll">
			...
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.customer1" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				...
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.customer2" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				...
				<el-col :span="8">
					...
					<!-- <p style="overflow: hidden;">
						<el-select v-model="formLabelAlign.currency" placeholder="select" style='width: 100%;' :disabled="type=='detail'?true:false">
		...
		<div>
			<el-row style='line-height: 35px;'>
				...
				<el-col :span="8">
					<span class="fl">Purchase Date：</span>
					<p style="overflow: hidden;">
						<el-date-picker v-model="formLabelAlign.guestDate" type="date" placeholder="select" style='width: 100%;' 
				...
				<el-col :span="8">
					<span class="fl">Factory Date：</span>
					<p style="overflow: hidden;">
						<el-date-picker v-model="formLabelAlign.plantDate" type="date" placeholder="select" style='width: 100%;' 
						 :disabled="type=='detail'?true:false">
						</el-date-picker>
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.goldColour" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				...
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.numbe" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.size1" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Size Unit(單位)：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.sizeUnit" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
		...
		<div style="font-size: 14px;font-weight: bold;line-height: 30px;height: 40px;margin-top: 20px;">
			<div style="width: 100px;border-bottom: 1px solid black;height: 14px;float: left;"></div>
			<span class="fl" style="padding: 0 5px;">Base Information</span>
			<div style="width: 100px;border-bottom: 1px solid black;height: 14px;float: left;"></div>
		</div>
		<!-- ||||||||||||||||||||| -->
		<div>
			<el-row style='line-height: 35px;'>
				...
				<el-col :span="8">
					<span class="fl">Salesman：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.sales" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
					
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Delivery Date：</span>
					<p style="overflow: hidden;">
						<el-date-picker v-model="formLabelAlign.claimDay" type="date" placeholder="select" style='width: 100%;' 
						 :disabled="type=='detail'?true:false">
						</el-date-picker>
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				...
				<el-col :span="8">
					<span class="fl">Big Day：</span>
					<p style="overflow: hidden;">
						<el-date-picker v-model="formLabelAlign.bigDay" type="date" placeholder="select" style='width: 100%;' 
						 :disabled="type=='detail'?true:false">
						</el-date-picker>
					</p>
				</el-col>
				...
				<el-col :span="8">
					<span class="fl">Factory：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.factory" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					<span class="fl">Design Code：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.designCode" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				...
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.salesCode" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Print：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.mintMark" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.explain" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div style="font-size: 14px;font-weight: bold;line-height: 30px;height: 40px;margin-top: 20px;">
			<div style="width: 100px;border-bottom: 1px solid black;height: 14px;float: left;"></div>
			<span class="fl" style="padding: 0 5px;">Production requirement</span>
			<div style="width: 100px;border-bottom: 1px solid black;height: 14px;float: left;"></div>
		</div>
		<!-- ||||||||||||||||||||| -->
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					<span class="fl">Production cost $RMB：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.costLaborRmb" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Production cost $Hk：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.costLaborHk" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Other cost $RMB：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.otherExpensesHk" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					<span class="fl">Factory Invoice NO：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.factoryInvoice" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Factory Price $RMB：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.factoryPriceRmb" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Factory Price $HK：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.factoryPriceHk" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<el-date-picker v-model="formLabelAlign.landingDate" type="date" placeholder="select" style='width: 100%;' 
						 :disabled="type=='detail'?true:false">
						</el-date-picker>
					</p>
				</el-col>
				...
				<el-col :span="8">
					<span class="fl">Payment record：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.factoryRecord" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Factory Name：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.oemName" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					<span class="fl">Notes on Other Expenditures：</span>
					<p style="overflow: hidden;">
						<el-date-picker v-model="formLabelAlign.otherExpensesExplain" type="date" placeholder="select" style='width: 100%;' 
						 :disabled="type=='detail'?true:false">
						</el-date-picker>
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					<span class="fl">Total number of stones：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.totalStone" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Total card of stones：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.totalStoneCard" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Total price of stones：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.totalStoneCost" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					<span class="fl">Gold content：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.gold1" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Total weight of gold：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.goldWeight" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				...
				<el-col :span="8">
					<span class="fl">Amount：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.goldUnivalence" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
		...
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.totalCost" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
			</el-row>
		</div>
		...
		<div style="font-size: 14px;font-weight: bold;line-height: 30px;height: 40px;margin-top: 20px;">
			<div style="width: 100px;border-bottom: 1px solid black;height: 14px;float: left;"></div>
			<span class="fl" style="padding: 0 5px;">Record Information</span>
			<div style="width: 100px;border-bottom: 1px solid black;height: 14px;float: left;"></div>
		</div>
		<!-- ||||||||||||||||||||| -->
		<div>
			<el-row style='line-height: 35px;'>
				<el-col :span="8">
					<span class="fl">GP total：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.gpAmount" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				
				<el-col :span="8">
					<span class="fl">Net sales：</span>
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.netSales" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
				...
				<el-col :span="8">
					...
					<p style="overflow: hidden;">
						<input v-model="formLabelAlign.sellingPrice" :disabled="type=='detail'?true:false" class="tem_input">
					</p>
				</el-col>
