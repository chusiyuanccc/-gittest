<template>
	<div class="MoBangXinZeng">
			 ...
			 :rules="rules">
				<!-- <div style="width: 50%; float: left;"> -->
					...
					<el-form-item label="Product" class='mat20 table30 m15'>
						<el-input v-model="formLabelAlign.product" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>

					<el-form-item label="Category" class='mat20 table30'>
						<el-input v-model="formLabelAlign.gold" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					...
					<el-form-item label="Quality" class='mat20 table30'>
						<el-input v-model="formLabelAlign.goldColour" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Amount" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.numbe" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Size(單雙)" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.size" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Size" class='mat20 table30'>
						<el-input class='inputs' v-model="formLabelAlign.size1" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Size Unit(單位)" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.sizeUnit" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="State" class='mat20 table30 m15'>
						<el-select v-model="formLabelAlign.plvKGuestBillType" placeholder="Select" style="float: left;width: 300px;"
						 :disabled="type=='detail'?true:false">
					...
					<el-form-item label="Inlay Stone" class='mat20 table30'>
						<el-select v-model="formLabelAlign.stone1" placeholder="Select" style="float: left;width: 300px;"
						 :disabled="type=='detail'?true:false">
					...
					<el-form-item label="around" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.around" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
			...
			<el-form label-position="top" placeholder="Input" ref='formLabelAlign' label-width="130px" :model="formLabelAlign"
			 :rules="rules">
					<el-form-item label="Company" class='mat20 table30'>
						<el-input v-model="formLabelAlign.company" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					...
					<el-form-item label="Factory" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.factory" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>

					<el-form-item label="Design Code" class='mat20 table30'>
						<el-input class='inputs' v-model="formLabelAlign.designCode" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Sales No" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.salesCode" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Print" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.mintMark" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
			...
			<el-form label-position="top" placeholder="Input" ref='formLabelAlign' label-width="130px" :model="formLabelAlign"
			 :rules="rules">
					<el-form-item label="Production cost $RMB" class='mat20 table30'>
						<el-input v-model="formLabelAlign.costLaborRmb" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Production cost $Hk" class='mat20 table30 m15'>
						<el-input v-model="formLabelAlign.costLaborHk" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Other cost $RMB" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.otherExpensesHk" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>

					<el-form-item label="Factory Invoice NO" class='mat20 table30'>
						<el-input class='inputs' v-model="formLabelAlign.factoryInvoice" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Factory Price $RMB" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.factoryPriceRmb" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Factory Price $HK" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.factoryPriceHk" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					...
					<el-form-item label="Payment record" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.factoryRecord" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
					<el-form-item label="Factory Name" class='mat20 table30 m15'>
						<el-input class='inputs' v-model="formLabelAlign.oemName" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
					</el-form-item>
			...
			<el-form label-position="top" placeholder="Input" ref='formLabelAlign' label-width="130px" :model="formLabelAlign"
			 :rules="rules">
				<el-form-item label="Total number of stones" class='mat20 table30'>
					<el-input v-model="formLabelAlign.totalStone" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Total card of stones" class='mat20 table30 m15'>
					<el-input v-model="formLabelAlign.totalStoneCard" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Total price of stones" class='mat20 table30 m15'>
					<el-input class='inputs' v-model="formLabelAlign.totalStoneCost" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Gold content" class='mat20 table30'>
					<el-input class='inputs' v-model="formLabelAlign.gold1" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Total weight of gold" class='mat20 table30 m15'>
					<el-input v-model="formLabelAlign.goldWeight" placeholder="Input" class='inputs' :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Amount" class='mat20 table30 m15'>
					<el-input class='inputs' v-model="formLabelAlign.goldUnivalence" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Total price" class='mat20 table30'>
					<el-input class='inputs' v-model="formLabelAlign.totalCost" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
			...
			<el-form label-position="top" placeholder="Input" ref='formLabelAlign' label-width="130px" :model="formLabelAlign"
			 :rules="rules">
				<el-form-item label="GP total" class='mat20 table30'>
					<el-input class='inputs' type="email" v-model="formLabelAlign.gpAmount" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Net sales" class='mat20 table30 m15'>
					<el-input class='inputs' type="email" v-model="formLabelAlign.netSales" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
				<el-form-item label="Price" class='mat20 table30 m15'>
					<el-input class='inputs' type="email" v-model="formLabelAlign.sellingPrice" placeholder="Input" :disabled="type=='detail'?true:false" style="width: 300px;"></el-input>
				</el-form-item>
			</el-form>
		</div>
		...
		<div style="background: rgb(233,238,244);padding: 1px 20px;width: 100%;border-radius: 10px;float: left;min-width:1300px;padding: 10px;">
			<el-row>
				<el-col :span="3">
			...
			<el-row>
				<el-col :span="21">
					<div class="input-content ">
						<img @click="add" style="width: 30px;height: 30px;margin-top: 10px;cursor: pointer;margin-left: 50%;" src="../../../image/add.png" v-if="type!='detail'"/>
					</div>
				</el-col>
			</el-row>
		</div>
		...
		<div class='mat20' style="white-space: nowrap;float: left;margin: 30px 0;margin-left: 30%;">
			<el-button :loading="loading" class='button' type="primary" style='background: rgb(253,99,99);border:none;font-size: 18px;' @click="cheak_userId()" v-if="type!='detail'">Submit</el-button>
			...
			search(){
				if (this.type == 'detail') {
					...
					this.$api.get('/PlvKClientCardEndpoint/seekPlvKGuestBillcol/' + this.$route.query.uuid, null, r => {
						...
						// console.log(r.plvKProductEntityList[0].stone)
			...
			submitForm(formLabelAlign) {
				...
				if (this.type == 'alert') {
					...
					for( var i = 0; i < this.formLabelAlign.plvKAVIEcesEntityList.length; i++){
						this.formLabelAlign.totalPrice = parseFloat(this.formLabelAlign.plvKAVIEcesEntityList[i].hk) + this.formLabelAlign.totalPrice
					...
					this.$api.post('/PlvKClientCardEndpoint/update', {
						plvKProductSaveDtoList: [{
							...
							"plantDate": new Date(this.formLabelAlign.plantDate).format("yyyy-MM-dd"),
						...
						plvKAviEceOemSaveDtoList: [{
							...
							"landingDate": new Date(this.formLabelAlign.landingDate).format("yyyy-MM-dd"),
						...
						plvKGuestBillSaveDtoList: [{
							"bigDay": new Date(this.formLabelAlign.bigDay).format("yyyy-MM-dd"),
							"claimDay": new Date(this.formLabelAlign.claimDay).format("yyyy-MM-dd"),
							...
							"landingDay": new Date(this.formLabelAlign.landingDay).format("yyyy-MM-dd"),
...
// 							"designName": this.plvKStoneTotalSaveDtoList[0].designName,
					...
					this.$api.post('/PlvKClientCardEndpoint/save', {
						plvKProductSaveDtoList: [{
							...
							"numbe": parseInt(this.formLabelAlign.numbe),
							"plantDate": this.formLabelAlign.plantDate.format("yyyy-MM-dd"),
							"plvKProductcol": "",
							"product": this.formLabelAlign.product,
							"reference": "",
							"size": this.formLabelAlign.size,
						...
						plvKAviEceOemSaveDtoList: [{
							...
							"factoryPriceRmb": parseInt(this.formLabelAlign.factoryPriceRmb),
							"factoryRecord": this.formLabelAlign.factoryRecord,
							"landingDate": this.formLabelAlign.landingDate.format("yyyy-MM-dd"),
							"oemName": this.formLabelAlign.oemName,
							"oemRefenece": "",
							"otherExpensesExplain": this.formLabelAlign.otherExpensesExplain,
							"otherExpensesHk": parseInt(this.formLabelAlign.otherExpensesHk),
						...
						plvKGuestBillSaveDtoList: [{
							"bigDay": this.formLabelAlign.bigDay.format("yyyy-MM-dd"),
							"claimDay": this.formLabelAlign.claimDay.format("yyyy-MM-dd"),
							"company": this.formLabelAlign.company,
							"designCode": this.formLabelAlign.designCode,
							"elseReference": '',
							"explain": this.formLabelAlign.explain,
							"factory": this.formLabelAlign.factory,
							"landingDay": this.formLabelAlign.landingDay.format("yyyy-MM-dd"),
							"mintMark": this.formLabelAlign.mintMark,
							"onLock": 0,
							"plvKGuestBillType": this.formLabelAlign.plvKGuestBillType,
							"proChecking": '',
...
// 							"designName": "",
			...
			del(index) {
				...
				this.$api.get('/PlvKClientCardEndpoint/deletePlvKStone/' + this.formLabelAlign.plvKAVIEcesEntityList[index].refenece, null, r => {
					console.log('****************************')
					this.formLabelAlign.plvKAVIEcesEntityList.splice(index, 1)
					this.search();
				});
