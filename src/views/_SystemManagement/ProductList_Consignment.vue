					...
					<div class="grid-content bg-purple-dark" style="height: 40px;">
						...
						<div>
							<el-form :inline="true" :model="formInline" class="demo-form-inline">
								...
								<div style="font-size: 18px;font-weight: bold;padding-left: 20px;float: left;line-height: 40px;">Product Type</div>
            ...
            >
					...
					<el-table-column prop="weight" label="Picture">
						<template slot-scope="scope">
							...
							<img style="max-height:80px; max-width:100px" :src="root+'/kernal/asset/'+scope.row.photo.reference" />
						</template>
					</el-table-column>
        ...
        return ((parseInt(this.page01)-1)*10+index+1) ;
			...
			search() {
				...
				if(this.types_name=='ALL'){
					...
					this.$api.get('/product/'+(this.page01-1)+'/6', null, r => {
