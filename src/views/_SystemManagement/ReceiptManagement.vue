				...
				<el-col :span="24">
					<div class="grid-content bg-purple-dark" style="height: 40px;">
						...
						<div style="width: 300px;margin-left: 0;float: left;">
							...
							<el-date-picker v-model="dateOne" type="date" placeholder="选择日期" style='width: 150px;float: right;margin-right:20px ;'>
							</el-date-picker> -->
						</div>
						<div>
		...
		<div style="border-radius: 10px;background: white;height: 385px;width: 100%;" >
			<div>
				...
				<el-table :data="tableData1" height="700" ref="singleTable01" :header-cell-style="titlebg" style='border-radius: 10px;'>
					<el-table-column prop="billingDate" label="Bank" row-style='background:red' >
					</el-table-column>
					<el-table-column prop="requiredDeliveryDate" label="Date" >
						<template slot-scope="scope">
							<span type="text" size="small" style="">{{new Date(scope.row.requiredDeliveryDate).format("yyyy-MM-dd")}}</span>
						</template>
					</el-table-column>
					
					
					<el-table-column prop="productName" label="祈付" >
						<!-- 入庫 -->
					</el-table-column>
					
					<el-table-column prop="customerName" label="HKD" >
						<!-- 可用 -->
					</el-table-column>
					
					
					<el-table-column prop="productCategory" label="Company">
					</el-table-column>
						...
						<el-table-column fixed="right" label="Action" style='background: red;'>
							<template slot-scope="scope">
								<div style="white-space: nowrap;">
									...
									<el-button  @click="handleClick(scope.row.reference)" type="danger" size="small">查看</el-button>
...
// 					});
			...
			tocreate() {
				...
				this.$router.push("/NewReceipt?type=new")
			},

			handleClick(id) {

				this.$router.push("/NewReceipt?type=detail&id=" + id)
