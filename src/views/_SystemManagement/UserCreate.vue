		...
		<div style="background: rgb(233,238,244);padding: 1px 20px;width: 100%;border-radius: 10px;">
			<el-form label-position="top" ref='formLabelAlign' label-width="80px" :model="formLabelAlign" :rules="rules">
				...
				<el-form-item label="Address" class='mat20 fl table30 ml5'>
					<el-input class='inputs' v-model="formLabelAlign.family" :disabled="type=='detail'?true:false"></el-input>
				</el-form-item>
				...
				<el-form-item label="Password" class='mat20 fl table30 ml5' v-show="type!='new'?false:true">
					<el-input class='inputs' v-model="formLabelAlign.password" :disabled="type=='detail'?true:false"></el-input>
				</el-form-item>



				<el-form-item label="Birth" class='mat20 fl table30 ' :class="type!='new'?'ml5' : '' ">
					<el-date-picker class='inputs' v-model="formLabelAlign.birth" type="date" placeholder="Date" style="float: left;width: 90%;"
				...
				<el-form-item label="State" class='mat20 fl table30 ' style='margin-bottom: 20px;' :class="type!='new'?'' : 'ml5' ">
