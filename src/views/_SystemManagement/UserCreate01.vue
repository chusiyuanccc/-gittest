    ...
    <div class="productSave"  style="max-width: 700px;margin: 0 auto;background: white;padding: 30px;border-radius: 10px;">
      <el-form :model="formLabelAlign"  label-width="120px" class="demo-ruleForm">
        <div style="width: 100%;color: white;background: deepskyblue;line-height: 30px;margin-bottom: 10px;">
          <strong style="margin-left: 10px;">User</strong>
        </div>

        <el-form-item label="Nickname" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.nickname"></el-input>
        </el-form-item>

        <el-form-item label="Mobile" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.mobile"></el-input>
        </el-form-item>

        <el-form-item label="Family" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.family"></el-input>
        </el-form-item>

        <el-form-item label="Given" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.given"></el-input>
        </el-form-item>

        <el-form-item label="Email" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.email"></el-input>
        </el-form-item>

        <el-form-item label="Identifier" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.identifier"></el-input>
        </el-form-item>

        <el-form-item label="Middle" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.middle"></el-input>
        </el-form-item>

        <el-form-item label="Password" prop="codePro">
          <el-input placeholder="input" :disabled="type=='detail'" type="text" v-model="formLabelAlign.password"></el-input>
        </el-form-item>

        <el-form-item label="Birth" prop="codePro">
        ...
        <el-form-item label="State" prop="codePro">
		...
		created: function() {
			...
			if (this.type == 'detail') {
				this.$api.get('/member/' + this.$route.query.uuid, null, r => {
					...
					this.formLabelAlign = r.plvKMemberDto
					this.activateds = r.plvKMemberDto.activated == 1 ? true : false
					console.log(r)
				});
