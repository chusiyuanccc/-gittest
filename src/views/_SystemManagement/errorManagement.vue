						...
						<div class="grid-content bg-purple-dark" >
							...
							<div>
								<el-form :inline="true" :model="formInline" class="demo-form-inline">
									...
									<!-- <div style="font-size: 18px;font-weight: bold;padding-left: 20px;float: left;line-height: 40px;">Error Management</div> -->
...
<script>
	export default {
		...
		created: function() {
			...
			this.$api.get('/miscellaneous/exception/count',
				null, r => {
      ...
      indexMethod(index) {
        return ((parseInt(this.page01)-1)*10+index+1) ;
			...
			search() {
				...
				this.tableData=[]
				this.$api.get('/miscellaneous/exception/'+(this.page01-1)+'/10',
					null, r => {
			...
			detail(uuid) {
				this.$router.push("/errorDeail?uuid="+uuid)
			},
