<template>
	...
	<div class="reservemanagement" style="height: 800px;" v-loading='all_loading'  >
						...
						<div>
							<el-form :inline="true" :model="formInline" class="demo-form-inline">
								<el-form-item style='float: left;height: 40px;' class='search' >
									<el-input v-model="formInline.search" placeholder="Certificate No" style='margin-left: 15px;width: 256px;height: 40px;line-height: 40px;'></el-input>
								</el-form-item>
								<el-form-item style='float:left;height: 35px;' >
									<el-button type="primary" @click="onSubmit01" style='height:40px;border:0;background: rgb(5,120,209);'>Search</el-button>
								</el-form-item>
								<!-- <div style="font-size: 18px;font-weight: bold;padding-left: 20px;float: left;line-height: 40px;">Gem Info</div> -->
		...
		<!-- 批次 -->
		<!-- <div style="margin-top: 20px;font-size: 18px;font-weight: bold;padding-left: 20px;">Gem Info</div> -->
          ...
          <el-table-column prop="id" label="Id"  width="80px">
            ...
            >
				...
				<!-- 	<el-table-column prop="weight" label="pictury" >
					...
					<div class="action">
						<el-table-column fixed="right" label="Action"  align='center' style='background: red;' width="150px">
							<template slot-scope="scope">
								<div style="white-space: nowrap;width: 100px;margin: 0 auto;">
	...
	export default {
		...
		created: function() {
			...
			// console.log(temp)
				...
				// this.$api.get('/inventory/gem/certified', null, r => {
				// 	console.log(r)
				// 	this.tableData02=r
				// });
      ...
      indexMethod(index) {
        return ((parseInt(this.page01)-1)*10+index+1) ;
			...
			tocreate() {
				this.$router.push("/GemInfo?type=new")
			},

			handleClick(id) {

				// //console.log('-----' + id)
				this.$router.push("/GemInfo?type=detail&id=" + id)
        ...
        if(this.formInline.search==""){
          ...
          this.$api.post('/inventory/gem/certified/'+'1970-01-01'+'/'+new Date().format("yyyy-MM-dd")+'/'+(this.page01-1)+'/10', {}, r => {
          	this.tableData02 = r;
          ...
          this.$api.post('/inventory/gem/certified/'+'1970-01-01'+'/'+new Date().format("yyyy-MM-dd")+'/'+(this.page01-1)+'/10', {
            certificateNo:this.formInline.search
          }, r => {
