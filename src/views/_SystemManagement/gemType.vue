					...
					<div class="grid-content bg-purple-dark" style="height: 40px;">
						...
						<div>
							<el-form :inline="true" :model="formInline" class="demo-form-inline">
								...
								<!-- <div style="font-size: 18px;font-weight: bold;padding-left: 20px;float: left;line-height: 40px;">Gem Type</div> -->
		...
		<div style="border-radius: 10px;background: white;height: 650px;width: 100%;" >
          ...
          <el-table-column prop="id" label="Id" width="80px" >
            ...
            >
					...
					<el-table-column prop="name" label="Name" width="200px" >  <!-- 入庫 -->
					</el-table-column>
					...
					<el-table-column prop="weight" label="Picture" >
						<template slot-scope="scope">
							...
							<img style="max-height:80px; max-width:200px" :src="scope.row.image" />
						</template>
					</el-table-column>
                  ...
                  <el-button  @click="handleClick(scope.row.reference,scope.row.image,scope.row.name)" type="danger"  size="small" >Modify</el-button>
                  <el-button @click="deletes(scope.row.reference)" type="danger" size="small">Delete</el-button>
									<!-- <el-button  @click="handleClick(scope.row.reference,scope.row.image,scope.row.name)" type="danger"  size="small" >Delete</el-button> -->
								</div>
							</template>
						</el-table-column>
	...
	export default {
      ...
      indexMethod(index) {
        return ((parseInt(this.page01)-1)*10+index+1) ;
			...
			tocreate() {
				this.$router.push("/gemTypeCreate?type=new")
			},

			handleClick(id,img,name) {

				// //console.log('-----' + id)
				this.$router.push("/gemTypeCreate?type=alter&id=" + id+'&img='+img+'&name='+name)
			...
			search() {
				...
				// }else{
					...
					if (this.dateTwo) {
						...
						this.$api.post('/inventory/' + this.page01 + '/8', {
							"eDate": this.dateTwo[1].format("yyyy-MM-dd"),
							"branch": entrepotId,
							"item": search == '' ? "" : search,
							"sDate": this.dateTwo[0].format("yyyy-MM-dd")
