<template>
	...
	<div class="UserManagement">
						...
						<div>
							<el-form :inline="true" :model="formInline" class="demo-form-inline">
								...
								<el-form-item style='float:right;'>
									<el-button type="primary" @click="usercreate" style='height:40px;padding: 0 px;border:0;background: rgb(5,120,209);'>New</el-button>
								</el-form-item>
		...
		<div style="border-radius: 10px;background: white;height: 675px;width: 100%;margin-top: 20px;" >
          ...
          <el-table-column prop="color.name" label="Color" width="200px">
          </el-table-column>
...
// 			});
      ...
      indexMethod(index) {
        ...
        return (index+1) ;
			...
			usercreate() {
				this.$router.push("/materialCreate?type=new")
			},

			detail(uuid) {
				this.$router.push("/materialCreate?type=detail&uuid=" + uuid)
			},
			alert(uuid) {
				this.$router.push("/materialCreate?type=alert&uuid=" + uuid)
			},
			//重置密码
			reset(name) {
