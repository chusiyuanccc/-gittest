					...
					<div class="grid-content bg-purple-dark" style="height: 40px;">
						...
						<div>
							<el-form :inline="true" :model="formInline" class="demo-form-inline">
								...
								<!-- <div style="font-size: 18px;font-weight: bold;padding-left: 20px;float: left;line-height: 40px;">Payment Method</div> -->
		...
		<div style="border-radius: 10px;background: white;height: 675px;width: 100%;margin-top: 20px;" >
          ...
          <el-table-column prop="id" label="Id" width="80px" >
            ...
            >
					...
					<el-table-column prop="method" label="Method" width="200px">
					</el-table-column>
...
// 			});
      ...
      indexMethod(index) {
        ...
        this.$api.get('/miscellaneous/paymentmethod/count',null, r => {
        	...
        	this.totalElements = r
				...
				// this.$api.get('/miscellaneous/orderstatus/'+(this.page01-1)+'/10',null, r => {
					this.$api.get('/miscellaneous/paymentmethod/'+(this.page01-1)+'/10',null, r => {
			...
			confirm_detele() {
				...
				this.$api.delete('/miscellaneous/paymentmethod/' + this.statusid+'/purge', null, r => {
					console.log('****************************')
					this.search();
				});
			...
			usercreate() {
				this.$router.push("/materialCreate_payMethod?type=new")
			},

			detail(uuid) {
				this.$router.push("/materialCreate_payMethod?type=detail&uuid=" + uuid)
			},
			alert(uuid,name,enable,id) {
				this.$router.push("/materialCreate_payMethod?type=alert&uuid=" + uuid)
			},
			//重置密码
			reset(name) {
