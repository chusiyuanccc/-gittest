    ...
    <div style="border-radius: 10px;background: white;height: 676px;width: 100%;" >
      <div>
        ...
        <el-table :data="tableData" :header-cell-style="titlebg" style="width: 100%;text-align: center;margin: 0;padding: 0;height: 620px;border-radius: 10px;">
          ...
          <el-table-column prop="identifier" label="Username">
          </el-table-column>
          <el-table-column prop="mobile" label="Tel">
          </el-table-column>
          ...
          <el-table-column prop="activated" label="Jurisdiction">
            <template slot-scope="scope">
              <span>{{scope.row.activated == 1 ? "Yes" : "No"}}</span>
            </template>
          </el-table-column>
          <el-table-column fixed="right"  align='center' label="Action" width="200">
            <template slot-scope="scope" >
...
<script>
  export default {
    ...
    created: function() {
      ...
      this.$api.get('/member/count',null, r => {
...
// 			},
      modify(uuid) {
        this.$router.push("/testNewUser?type=alert&uuid=" + uuid)
      },
      topage(type) {
        if (type == 'user') {
          this.$router.push("/SystemManagement/CustomerOrderManagement")
      ...
      detail(uuid) {
        this.$router.push("/testNewUser?type=detail&uuid=" + uuid)
      },
      alert(uuid) {
        this.$router.push("/testNewUser?type=alert&uuid=" + uuid)
      },
