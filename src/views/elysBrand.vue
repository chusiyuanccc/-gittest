  ...
  <div class="elysBrand">
            ...
            <div>
              <el-form :inline="true" :model="formInline" class="demo-form-inline">
                  <el-form-item style='float:left;'>
                      <h3>System Settings - Luxury Brand</h3>
                  </el-form-item>
                ...
                <el-form-item style='float:right;'>
                  <el-button type="primary" @click="brandcreate" style='height:40px;padding: 0 10px;border:0;'>New</el-button>
                </el-form-item>
              </el-form>
            </div>
          </div>
    ...
    <div style="border-radius: 10px;background: white;height: 676px;width: 100%;" >
      <div>
        <el-table :data="tableData" :header-cell-style="titlebg" style="width: 100%;text-align: center;margin: 0;padding: 0;height: 620px;border-radius: 10px;">
          ...
          <el-table-column prop="name" label="Brand" width="300px" align='center'>
          </el-table-column>
    ...
    <div class="tishi">
      <el-dialog title="Tips" :visible.sync="dialogVisible" width="30%" :before-close="handleClose" top='20%'>
        <span>Do you really want to delete this Brand?</span>
...
<script>
  export default {
    ...
    created: function() {
      this.$api.get('/miscellaneous/brand/count/',null, r => {
    ...
    methods: {
      ...
      confirm_state(){
        this.$api.put('/miscellaneous/brand/'+this.member_reference+'/group/'+this.options+'/assign',null, r => {
          this.search()
      ...
      search() {
        ...
        this.tableData=[]
        this.$api.get('/miscellaneous/brand/'+(this.page01-1)+'/'+this.sum,null, r => {
          this.tableData = r;
        });
      },
      onSubmit() {
      ...
      confirm_detele() {
        ...
        // this.$api.detele('/miscellaneous/brand/' + this.statusid, null, r => {
        this.$api.delete('/miscellaneous/brand/' + this.dialogVisible_reference + '/purge', null, r => {
          this.search();
        });
      },
      ...
      brandcreate() {
        this.$router.push("/elysBrandCreate?type=new")
      },
      // 上載
// 			shangzai(){
...
// 			},
      ...
      detail(uuid) {
        this.$router.push("/elysBrandCreate?type=detail&uuid=" + uuid)
      },
      alert(uuid) {
        this.$router.push("/elysBrandCreate?type=alert&uuid=" + uuid)
      },
