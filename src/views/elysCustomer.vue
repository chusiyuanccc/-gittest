            ...
            <div>
              <el-form :inline="true" :model="formInline" class="demo-form-inline">
                ...
                <el-form-item style='float:right;'>
                  <el-button type="primary" @click="customercreate" style='height:40px;padding: 0 10px;border:0;'>New</el-button>
                </el-form-item>
              </el-form>
            </div>
          </div>
    ...
    <div style="border-radius: 10px;background: white;height: 676px;width: 100%;" >
      <div>
        <el-table :data="tableData" :header-cell-style="titlebg" style="width: 100%;text-align: center;margin: 0;padding: 0;height: 620px;border-radius: 10px;">
          ...
          <el-table-column prop="name" label="Name" width="250px" align='center'>
          </el-table-column>
          <el-table-column prop="tel" label="Telphone" width="250px" align="center">
          </el-table-column>
          <el-table-column prop="email" label="Email" width="250px" align="center">
          </el-table-column>
...
<script>
  export default {
    ...
    created: function() {
      this.$api.get('/customer/count',null, r => {
    ...
    methods: {
      ...
      confirm_state(){
        this.$api.put('/customer/'+this.member_reference+'/group/'+this.options+'/assign',null, r => {
          this.search()
      ...
      search() {
        ...
        this.tableData=[]
        this.$api.get('/customer/'+(this.page01-1)+'/'+this.sum,null, r => {
          this.tableData = r;
        });
      },
      onSubmit() {
      ...
      confirm_detele() {
        this.dialogVisible = false
        this.$api.delete('/customer/' + this.dialogVisible_reference + '/purge', null, r => {
          this.search();
        });
      },
      detele(reference){
      ...
      customercreate() {
        this.$router.push("/elysCustomerCreate?type=new")
      },
      return_guest() {
      ...
      detail(uuid) {
        this.$router.push("/elysCustomerCreate?type=detail&uuid=" + uuid)
      },
      alert(uuid) {
        this.$router.push("/elysCustomerCreate?type=alert&uuid=" + uuid)
      },
    }
  }
</script>
