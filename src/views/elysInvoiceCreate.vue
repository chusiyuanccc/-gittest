      ...
      var validateUser = (rule, value, callback) => {
        ...
        if (value != '') {
          this.$api.get('/member/seekIdentifier/' + value, null, r => {
            // //console.log(r)
            if (r == false) {
              callback(new Error('invoice已存在'));
            } else {
              callback();
            }
          });
        } else {
          callback(new Error('請輸入invocie'));
        }
    ...
    methods: {
      ...
      submitForm(formLabelAlign) {
        ...
        if(this.formLabelAlign.id==''||this.formLabelAlign.id==null){
          ...
          alert('Please input total order id');
        ...
        }else if (this.formLabelAlign.user.identifier==''||this.formLabelAlign.user.identifier==null){
          this.formLabelAlign.user.identifier=''
          alert('Please input email');
        }else if (this.formLabelAlign.city.name==''||this.formLabelAlign.city.name==null){
          this.formLabelAlign.city.name=''
          alert('Please input telephone');
        }else if (this.formLabelAlign.city.name==''||this.formLabelAlign.city.name==null){
          this.formLabelAlign.city.name=''
          alert('Please input shipping methond');
        }else if (this.formLabelAlign.city.name==''||this.formLabelAlign.city.name==null){
          this.formLabelAlign.city.name=''
