          ...
          <div class="grid-content bg-purple-dark" style="height: 40px;">
            ...
            <div>
              <el-form :inline="true" :model="formInline" class="demo-form-inline">
                ...
                <el-form-item style='float:right;'>
                  <el-button type="primary" @click="purreceiptcreate" style='height:40px;padding: 0 10px;border:0;'>New</el-button>
                </el-form-item>
              </el-form>
            </div>
          </div>
    ...
    <div style="border-radius: 10px;background: white;height: 676px;width: 100%;" >
      <div>
        ...
        <el-table :data="tableData" :header-cell-style="titlebg" style="width: 100%;text-align: center;margin: 0;padding: 0;height: 620px;border-radius: 10px;">
          ...
          <el-table-column prop="product" label="Purchase" width="200px" align='center'>
          </el-table-column>

          <el-table-column prop="product" label="Image">
          </el-table-column>
...
<!--              <el-button @click="alert(scope.row.reference)" type="danger" size="small" plain>Modify</el-button>-->
    ...
    <div class="tishi">
      <el-dialog title="Tips" :visible.sync="dialogVisible" width="30%" :before-close="handleClose" top='20%'>
        <span>Do you really want to delete this PurchaseReceipt?</span>
...
// 			this.value6.push(new Date(2020, 11, 1))
    ...
    methods: {
      ...
      purreceiptcreate() {
        this.$router.push("/elysPurReceiptCreate?type=new")
      },
      // 上載
// 			shangzai(){
...
// 			},
      ...
      alert(uuid) {
        this.$router.push("/elysPurReceiptCreate?type=alert&uuid=" + uuid)
      },
