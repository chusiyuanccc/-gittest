  ...
  <div class="ShippingMethod">
          ...
          <div class="grid-content bg-purple-dark" style="height: 40px;">
            ...
            <div>
              <el-form :inline="true" :model="formInline" class="demo-form-inline">
                ...
                <!-- <div style="font-size: 18px;font-weight: bold;padding-left: 20px;float: left;line-height: 40px;">Order Status</div> -->
                <el-form-item style='float:right;'>
                  <el-button type="primary" @click="methodcreate" style='height:40px;padding: 0 10px;border:0;'>New</el-button>
                </el-form-item>
    ...
    <div style="border-radius: 10px;background: white;height: 675px;width: 100%;margin-top: 20px;" >
      <div>
        ...
        <el-table :data="tableData" height="620" ref="singleTable01" :header-cell-style="titlebg" style='border-radius: 10px;'>
          ...
          <el-table-column prop="text" label="Method" width="200px" align="center" >
          </el-table-column>
          <el-table-column prop="enable" label="Status">
            <template slot-scope="scope">
              <span>{{scope.row.enable == 1 ? "Enable" : "Disable"}}</span>
            </template>
          </el-table-column>
    ...
    <div class="tishi">
      <el-dialog title="Tips" :visible.sync="dialogVisible" width="30%" :before-close="handleClose" top='20%'>
        <span>Do you really want to delete this Method?</span>
        <span slot="footer" class="dialog-footer">
  ...
  export default {
    ...
    methods: {
      ...
      confirm_detele() {
        ...
        this.$api.delete('/member/delete/' + this.statusid, null, r => {
          console.log('****************************')
          this.search();
        });
      },
      ...
      methodcreate() {
        this.$router.push("/elysShippingMethodCreate?type=new")
      },

      detail(uuid) {
        this.$router.push("/elysShippingMethodCreate?type=detail&uuid=" + uuid)
      },
      alert(uuid) {
        this.$router.push("/elysShippingMethodCreate?type=alert&uuid=" + uuid)
      },
      //重置密码
      reset(name) {
