  ...
  export default {
    ...
    methods: {
      ...
      submitForm(formLabelAlign) {
        ...
        // }else
        if(this.formLabelAlign.identifier == ''||this.formLabelAlign.identifier == null) {
          this.formLabelAlign.identifier = ''
          alert('Please input username');
        }else if(this.formLabelAlign.mobile==''||this.formLabelAlign.mobile==null){
