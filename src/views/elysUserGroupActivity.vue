            ...
            <div>
              <el-form :inline="true" :model="formInline" class="demo-form-inline">
                  <el-form-item style='float:left;'>
                      <h3>Procurement Team Activity</h3>
                  </el-form-item>
              </el-form>
            </div>
          </div>
...
<script>
  export default {
    ...
    created: function() {
        ...
        this.$api.get('/member/group/activity/count', null, r => {
    ...
    methods: {
      ...
      search() {
        this.loaing_table=false
        this.tableData=[]
        this.$api.get('/member/group/activity/'+(this.page01-1)+'/'+this.sum, null, r => {
          for (let i = 0; i < r.length; i++) {
              r[i].name = r[i].user.given + ' ' + r[i].user.family
          }
          this.tableData = r
        })
      },
