<template>
  <div class="elysWarePurchase">
          ...
          <div class="grid-content bg-purple-dark" style="height: 40px;">
            ...
            <div>
              <el-form :inline="true" :model="formInline" class="demo-form-inline">
                ...
                <el-form-item style='float:right;'>
                  <el-button type="primary" @click="warepurchasecreate" style='height:40px;padding: 0 10px;border:0;'>New</el-button>
                </el-form-item>
              </el-form>
            </div>
          </div>
    ...
    <!-- 庫存列表 -->
    <!-- <div style="font-size: 18px;font-weight: bold;padding-left: 20px;line-height: 40px;">Permissions Management</div> -->
    <div style="border-radius: 10px;background: white;height: 676px;width: 100%;" >
      <div>
        ...
        <el-table :data="tableData" :header-cell-style="titlebg" style="width: 100%;text-align: center;margin: 0;padding: 0;height: 620px;border-radius: 10px;">
          ...
          <el-table-column prop="product" label="Purchase ID" width="200px" align='center'>
          </el-table-column>

          <el-table-column prop="product" label="Product" width="200px" align="center">
          </el-table-column>

          <el-table-column prop="product" label="Quantity">
          </el-table-column>
    ...
    <div class="tishi">
      <el-dialog title="Tips" :visible.sync="dialogVisible" width="30%" :before-close="handleClose" top='20%'>
        <span>Do you really want to delete this WarehousePurchase?</span>
...
<script>
  export default {
    ...
    created: function() {
      ...
      // this.$api.get('/member/group',null, r => {
      this.$api.get('/purchase',null,r=> {
...
// 			this.value6.push(new Date(2020, 11, 1))
    ...
    methods: {
      ...
      search() {
        ...
        this.$api.get('/purchase/0/100000',null, r => {
        ...
        // this.$api.post('/member/count',{
        //   nickname:this.formInline.seek==""?null:this.formInline.seek
        // }, r => {
        //
        //   console.log('*----------------*');
        //   console.log(r);
        ...
        // this.$api.post('/member/'+'1970-01-01'+'/'+new Date().format("yyyy-MM-dd")+'/'+(this.page01-1)+'/10',{
        //   nickname:this.formInline.seek==""?null:this.formInline.seek
        // }, r => {
        //
        //   console.log('----------------');
      ...
      confirm_detele() {
        ...
        this.$api.delete('/Design/delete/' + this.statusid, null, r => {
          //console.log('****************************')
          this.search();
        });
      },
      ...
      warepurchasecreate() {
        this.$router.push("/elysWarePurchaseCreate?type=new")
      },
      // 上載
// 			shangzai(){
...
// 			},
      ...
      detail(uuid) {
        this.$router.push("/elysWarePurchaseCreate?type=detail&uuid=" + uuid)
      },
      alert(uuid) {
        this.$router.push("/elysWarePurchaseCreate?type=alert&uuid=" + uuid)
      },
